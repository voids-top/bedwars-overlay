...
default = {'hypixel_key': None, 'antisniper_key': None, 'refresh': 100, 'mode': 'bedwars', 'fps': 30, 'opacity': 50, 'background': False, 'inject': False, 'deposit_notify': True, 'auto_party_transfer': True, 'notify_suspicious_player': True, 'autochat': False, 'geometry': '', 'volume': 10, 'position': 0, 'log_file': 'custom'}
...
validator = {
    ...
    "inject": lambda a: isinstance(a, bool),
